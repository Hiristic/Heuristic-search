...
def ProcessFile(message):
    try:
        ...
        # Unlink not needed at the moment
        # if (event == 'unlink'):
        ...
        fileData = ReadFileData("referencedata/LOCTITE 243 2020-06-23.pdf")
        ...
        # No parsed content available from API
        ...
        if not hasParsedContent:
            ...
            # Replace submit to API with print
            print("File content decoded {0}".format(fileContent.text.encode(encoding='utf_8', errors='ignore')))
...
def readFileContent(body):
    ...
    if (ProcessFile(message)):
        ...
        #logger.LogMessage('error', 'failed reading file')
